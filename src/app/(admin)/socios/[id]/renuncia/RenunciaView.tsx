  ...
  return (
    <div className="constancia-page">
      ...
      <article className="constancia renuncia">
        ...
        <h1 className="constancia__title">Carta de Renuncia</h1>
        ...
        <div className="constancia__body renuncia__body">
          ...
          <p>
            <b>ASUNTO:</b> Renuncia voluntaria e irrevocable como socio.
          </p>
          ...
          <p>
            ...
            {data.tipoDocumento} N.° <b>{data.numeroDocumento}</b>, peruano(a) de
            nacimiento, me dirijo a Usted con el debido respeto para presentar
            formalmente mi <b>RENUNCIA VOLUNTARIA E IRREVOCABLE</b> como socio(a)
            de la {ORG.nombre}.
          </p>

          {data.puestos.length > 0 && (
            <p>
              La presente renuncia comprende {unPuesto ? "el puesto" : "los puestos"}{" "}
              <b>{puestosTxt}</b>
              {data.alDia ? (
                <>
                  , respecto {unPuesto ? "del cual" : "de los cuales"} me
                  encuentro al día en el cumplimiento de todas mis obligaciones y
                  pagos ante la asociación.
                </>
              ) : (
                <>.</>
              )}
          ...
          <p>
            Asimismo, dejo constancia de que, a partir de la fecha de aceptación
            de la presente renuncia y formalización de la transferencia, los
            nuevos propietarios asumirán los derechos y obligaciones inherentes a
            dichos puestos, así como el cumplimiento de las normas que rigen la
            asociación.
          </p>
